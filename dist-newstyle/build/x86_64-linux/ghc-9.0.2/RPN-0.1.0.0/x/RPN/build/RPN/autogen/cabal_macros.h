...
/* package RPN-0.1.0.0 */
#ifndef VERSION_RPN
#define VERSION_RPN "0.1.0.0"
#endif /* VERSION_RPN */
#ifndef MIN_VERSION_RPN
#define MIN_VERSION_RPN(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_RPN */
...
#define CURRENT_COMPONENT_ID "RPN-0.1.0.0-inplace-RPN"
